...
async function add({
  ...
  block,
  sequelize,
  insertList = ['block_number', 'block_author', 'block_author_name',
    'block_hash', 'parent_hash', 'extrinsics_root', 'state_root',
    'is_election', 'session_length',
    'spec_name', 'spec_version', 'total_events',
