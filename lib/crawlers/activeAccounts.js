...
const makeQuery = (state, block, timestamp) => {
  ...
  const identityDisplay = identity.display.toString() || ``;
  ...
  const query = `                                                                                                                                                                          \
    ...
    VALUES        ('${id}', '${identity}', '${identityDisplay}', '${JSONbalances}', '${availableBalance}', '${freeBalance}', '${lockedBalance}', '${timestamp}', '${block}', ${isStaking}) \
