...
module.exports = {
  blockListener: async function (api, pool) {
      ...
      if (res.rows.length > 0) {
        ...
        blockEvents.forEach( async (record, index) => {
          ...
          try {
            ...
            console.log(`[PolkaStats backend v3] - Block listener - \x1b[31mError adding event #${blockNumber}-${index}: ${error.error}, sql: ${sqlInsert}\x1b[0m`);
          }
        });
      }
    });
