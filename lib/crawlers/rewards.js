  ...
  start: async function (api, pool, _config) {
    ...
    // Subscribe to new blocks
      await api.rpc.chain.subscribeNewHeads( async (header) => {
        ...
        if (currentEraIndex > currentDBIndex && storeRewards) {
          storeRewards = false;
          storeRewards = await module.exports.storeRewardsInfo(api, pool, blockNumber, currentEraIndex);
        }
    });
  },
