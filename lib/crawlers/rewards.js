...
module.exports = {
  ...
  storeRewardsInfo: async function (api, pool, blockNumber, currentEraIndex) {
    ...
    endEraValidatorList.forEach( async (validator, index) => {
      ...
      console.log(`[PolkaStats backend v3] - Rewards crawler - \x1b[33mValidator ${validator}, era:  {eraIndex} commission: ${eraValidatorCommission[index].commission} points: ${eraPoints.individual[validator]} exposure: ${exposure} KSM \x1b[0m`)
