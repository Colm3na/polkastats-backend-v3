...
module.exports = {
  ...
  storeRewardsInfo: async function (api, pool, blockNumber, currentEraIndex) {
    ...
    await pool.query(
      `INSERT INTO rewards (block_number, era_index, stash_id) VALUES ('${blockNumber}', '${currentEraIndex}', '--')`
    );
    ...
    await pool.query(
      `DELETE FROM rewards WHERE block_number = '${blockNumber}' AND era_index = '${currentEraIndex}' AND stash_id = '--';`
    );
