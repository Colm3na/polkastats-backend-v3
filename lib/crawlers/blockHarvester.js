...
module.exports = {
  async blockHarvester(api, pool, config) {
    console.log(
    ...
    console.log(
      `[PolkaStats backend v3] - Block harvester - \x1b[32mNext execution in 60m...\x1b[0m`,
    );

    setTimeout(
      () => module.exports.blockHarvester(api, pool, config),
      config.pollingTime,
    );
  },
