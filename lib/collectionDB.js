...
async function add({
  ...
  sequelize, 
  insertList = [
  'collection_id', 'owner', 'name', 'description', 'offchain_schema', 
  'token_limit','const_chain_schema', 'variable_on_chain_schema','limits_accout_ownership','limits_sponsore_data_size', 'limits_sponsore_data_rate','owner_can_trasfer',
  'owner_can_destroy',
  'sponsorship_confirmed',
  'schema_version', 'token_prefix', 'mode'
]}) {  
...
async function modify({
  ...
  sequelize,
  updateList = [
    'owner', 'name', 'description', 'token_limit', 'offchain_schema', 'const_chain_schema',
    'variable_on_chain_schema','limits_accout_ownership', 'limits_sponsore_data_size',
    'limits_sponsore_data_rate', 'owner_can_trasfer', 'owner_can_destroy', 'sponsorship_confirmed',
    'schema_version', 'token_prefix','mode'
  ]
}) {
