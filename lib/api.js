const { ProvierFactory } = require('./providerAPI/providerAPI.js');
const TypeProvider = require('./providerAPI/type/provider.js');
const { BridgeAPI } = require('./providerAPI/bridgeApi.js');
...
async function main () {
  ...
  const token = await bridgeAPI.getCollection(1);
